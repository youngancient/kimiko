        ...
        <div className="flex flex-col lg:flex-row   gap-6 items-center justify-start mt-5">
          ...
          <div className="w-full h-full">
            <div className="flex flex-col gap-3  items-start justify-start">
              ...
              <h1 className="lg:w-[577px] overflow-hidden  text-[#006] dark:text-white text-3xl lg:text-5xl font-bold">
                Distinctive Features
              </h1>
              <span className="lg:w-[703px]  text-black dark:text-white">
            ...
            {/* <div className=" border-2 p-3 lg:p-10 rounded-xl border-gray bg-[#F3F9FF] border-opacity-10 "> */}
